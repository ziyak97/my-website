        ...
        <section className={styles.about}>
            ...
            <div className={styles.container}>
                <div className={styles.description}>
                    ...
                    <p>While I'm graduating from a <a href="https://mu.ac.in/" target='_blank' rel="noopener noreferrer">Mumbai University</a> affiliated college, I spend the spare time that I have freelancing and teaching kids programming, always trying to pickup something new on the way.</p>
